var content_controller = function ($scope, $timeout, $sce) {
    ...
    const APP_URL = "/wiz/admin/packages/routes/editor/";
    ...
    BUILDER.app.editor = async () => {
        ...
        $scope.app.editor.code.langselect = LANGSELECTOR;
    ...
    socket.on("log", function (data) {
        ...
        $scope.session.log = $scope.session.log + data;
        $timeout(function () {
